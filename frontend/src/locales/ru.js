...
export default {
  ...
  "This browser doesn't support passkeys — you can still use SAATH locally on this device.": 'Этот браузер не поддерживает ключи доступа — но SAATH можно использовать локально на этом устройстве.',
  ...
  'to install SAATH as a full-screen app.': 'чтобы установить SAATH как полноэкранное приложение.',
  ...
  'Rest-timer alerts, even if SAATH is closed.': 'Оповещения таймера отдыха, даже если SAATH закрыт.',
  ...
  'A small file a friend imports into their own SAATH — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой SAATH — только программы, без твоих тренировок и взвешиваний.',
  ...
  'Reload SAATH': 'Перезагрузить SAATH',
