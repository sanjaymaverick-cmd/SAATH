...
export default {
  ...
  "This browser doesn't support passkeys — you can still use SAATH locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar SAATH localmente en este dispositivo.',
  ...
  'to install SAATH as a full-screen app.': 'para instalar SAATH como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if SAATH is closed.': 'Avisos del temporizador de descanso, incluso con SAATH cerrado.',
  ...
  'A small file a friend imports into their own SAATH — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio SAATH: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
