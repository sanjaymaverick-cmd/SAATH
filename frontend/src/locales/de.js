...
export default {
  ...
  "This browser doesn't support passkeys — you can still use SAATH locally on this device.": 'Dieser Browser unterstützt keine Passkeys — du kannst SAATH trotzdem lokal auf diesem Gerät nutzen.',
  ...
  'to install SAATH as a full-screen app.': 'um SAATH als Vollbild-App zu installieren.',
  ...
  'Rest-timer alerts, even if SAATH is closed.': 'Pausen-Timer-Alarm, auch wenn SAATH geschlossen ist.',
  ...
  'A small file a friend imports into their own SAATH — routines only, none of your workouts or weigh-ins.': 'Eine kleine Datei, die ein Freund in sein eigenes SAATH importiert — nur Routinen, keine Workouts oder Wiegungen.',
