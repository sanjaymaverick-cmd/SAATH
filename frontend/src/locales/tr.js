...
export default {
  ...
  "This browser doesn't support passkeys — you can still use SAATH locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de SAATH’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'to install SAATH as a full-screen app.': 'ile SAATH’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'Rest-timer alerts, even if SAATH is closed.': 'SAATH kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own SAATH — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi SAATH\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
